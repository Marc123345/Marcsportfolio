...
// --- NEW IMPORT ---
import { LuminousFeatureCard } from '../components/LuminousFeatureCard';
// ------------------
...
                {/* NOTE: I recommend adding 'rounded-none' to these existing cards 
                      if you want to strictly adhere to the "No Rounded Corners" rule.
                      For example: 'rounded-none overflow-hidden shadow-2xl...' */}
...
                  // The clipping path creates a sharp, non-rounded corner effect
...
      {/* --- NEW: Luminous Feature Card (High-Conversion Block) --- */}
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex justify-center">
          <LuminousFeatureCard
            title="The 7-Day Precision Audit"
            description="Stop guessing. Get a comprehensive, sharp analysis of your current site’s performance, conversion flaws, and a detailed, actionable plan for a high-impact rebuild. Zero fluff, pure ROI focus."
            ctaText="Claim Your Audit Slot"
...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            // REMOVED rounded-3xl here to adhere to the sharp corner policy
            className="bg-[#1b1b1b] overflow-hidden border border-white/10 hover:border-[#A3D1FF] transition-all group mb-12"
          >
...
                <span className="text-[#A3D1FF] text-sm bg-[#A3D1FF]/10 px-4 py-2 inline-block w-fit mb-4">Featured Project</span>
...
                    <span key={i} className="px-3 py-1 bg-white/5 text-[#A3D1FF] rounded-none text-sm">{tech}</span>
                  ))}
                </div>
                <div className="flex gap-3">
                  <a href="https://untappedafrica.co.za" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-white/5 text-white rounded-none hover:bg-white/10 transition-all">
                    View Live Website
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </a>
                  <Link to="/work/case-studies/untapped-africa" className="inline-flex items-center px-6 py-3 bg-[#A3D1FF] text-black rounded-none hover:bg-[#92bce6] transition-all">
                    Read Case Study
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </Link>
                </div>
...
                viewport={{ once: true }}
                // REMOVED rounded-2xl here to adhere to the sharp corner policy
                className="bg-[#1b1b1b] border border-white/10 overflow-hidden hover:border-[#A3D1FF] transition-all group"
              >
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    src={project.image}
...
                      <span key={i} className="px-2 py-1 bg-white/5 text-[#A3D1FF] rounded-none text-xs">{tech}</span>
                    ))}
                    {project.tech.length > 3 && (
                      <span className="px-2 py-1 bg-white/5 text-[#A3D1FF] rounded-none text-xs">+{project.tech.length - 3}</span>
                    )}
                  </div>
                  <div className="flex gap-2">
                    {project.liveUrl && (
                      <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-white/5 text-white text-sm rounded-none hover:bg-white/10 transition-all">
                        View Live
                      </a>
                    )}
                    <Link to={project.caseStudy} className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-[#A3D1FF]/10 text-[#A3D1FF] text-sm rounded-none hover:bg-[#A3D1FF]/20 transition-all">
                      Case Study
                    </Link>
                  </div>
                </div>
...
            <Link
              to="/work"
              className="inline-flex items-center px-10 py-5 bg-[#A3D1FF] text-black font-bold rounded-none hover:bg-[#92bce6] transition-all duration-300 text-xl"
            >
              View All Projects
...
              viewport={{ once: true }}
              // REMOVED rounded-2xl here to adhere to the sharp corner policy
              className="bg-[#1b1b1b] border border-white/10 overflow-hidden hover:border-[#A3D1FF] transition-all group relative"
            >
              <div className="absolute top-4 right-4 bg-[#A3D1FF] text-black px-3 py-1 rounded-none text-xs font-bold z-10">
                Featured
              </div>
...
                  <span className="text-xs text-[#FFD700] font-semibold uppercase">Award</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#A3D1FF] transition-colors">
                  Award Recognition
                </h3>
...
            <Link
              to="/press"
              className="inline-flex items-center px-10 py-5 bg-white/5 text-white font-bold rounded-none hover:bg-white/10 transition-all duration-300 text-xl border border-white/10"
            >
...
                viewport={{ once: true }}
                // REMOVED rounded-3xl here to adhere to the sharp corner policy
                className="card flex items-start gap-8 bg-[#1b1b1b] border border-white/10 p-10 hover:border-[#A3D1FF] transition-all duration-300"
              >
...
                target="_blank"
                rel="noopener noreferrer"
                // REMOVED rounded-full here to adhere to the sharp corner policy
                className="mr_btn inline-flex items-center px-10 py-5 bg-[#A3D1FF] text-black font-bold hover:bg-[#7FB3D5] transition-all duration-300 text-xl"
              >
                Let's Talk
...
                viewport={{ once: true }}
                // REMOVED rounded-2xl here to adhere to the sharp corner policy
                className="bg-[#1b1b1b] border border-white/10 overflow-hidden"
              >
...
                    <div className="w-8 h-8 flex items-center justify-center bg-[#A3D1FF]/30 flex-shrink-0">
...
            {/* Contact Form Block */}
            {/* REMOVED rounded-3xl here to adhere to the sharp corner policy */}
            <div className="bg-[#1b1b1b] border border-white/10 p-10 text-left max-w-2xl mx-auto">
...
                      required
                      // REMOVED rounded-xl here to adhere to the sharp corner policy
                      className="form-input w-full px-4 py-3 bg-white/80 border-2 border-[#A3D1FF]/30 text-black focus:outline-none focus:ring-2 focus:ring-[#A3D1FF] focus:border-transparent transition-all"
...
                    onChange={handleChange}
                    // REMOVED rounded-xl here to adhere to the sharp corner policy
                    className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 text-black focus:outline-none focus:ring-2 focus:ring-[#0066FF] focus:border-transparent transition-all"
                  >
...
                    rows={4}
                    // REMOVED rounded-xl here to adhere to the sharp corner policy
                    className="form-input w-full px-4 py-3 bg-white/80 border-2 border-[#A3D1FF]/30 text-black focus:outline-none focus:ring-2 focus:ring-[#A3D1FF] focus:border-transparent transition-all resize-none"
...
                  // REMOVED rounded-full here to adhere to the sharp corner policy
                  className="mr_btn w-full group bg-black text-white font-bold px-8 py-5 hover:bg-gray-900 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-xl"
                >
                  {isSubmitting ? (
                    <>
