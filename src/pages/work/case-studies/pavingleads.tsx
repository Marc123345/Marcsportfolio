    ...
    <div className="bg-[#050505] text-white selection:bg-[#F97316] selection:text-black min-h-screen font-sans overflow-x-hidden">
      ...
      <section className="py-20 px-6 text-center">
        ...
        <button 
          ...
          className="group relative inline-flex items-center gap-3 px-10 py-5 bg-white text-black font-bold rounded-full hover:bg-[#F97316] transition-all hover:pr-14"
        >
          Start Your Project
