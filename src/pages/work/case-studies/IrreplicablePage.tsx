...
import { ArrowRight, Star, Timer, Users, Target, Zap, CheckCircle2, ArrowUpRight, TrendingUp, Award, Clock, Sparkles } from 'lucide-react';
...
export default function IrreplicablePage() {
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-2xl text-gray-300 mb-6 leading-relaxed">
              A sophisticated sales page designed to position premium ghostwriting services at the highest tier of personal branding.
            </p>
            <p className="text-xl text-gray-400 mb-10 leading-relaxed">
              Through elegant design, compelling copy, and conversion-optimized UX, this project transformed visitor engagement and lead quality, setting new standards for service-based sales pages.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Irreplicable needed a premium sales page that would effectively communicate their unique value proposition in personal branding and ghostwriting services. The project focused on creating a sophisticated, conversion-optimized page that would attract high-value clients.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="text-gray-300">Communicating premium positioning and unique value proposition</p>
                </li>
                <li className="flex items-start">
                  <Star className="w-5 h-5 text-[#FFD700] mt-1 mr-3" />
                  <p className="text-gray-300">Need for sophisticated design that reflects service quality</p>
                </li>
                <li className="flex items-start">
                  <Star className="w-5 h-5 text-[#FFD700] mt-1 mr-3" />
                  <p className="text-gray-300">Complex service offerings requiring clear explanation</p>
                </li>
                <li className="flex items-start">
                  <Star className="w-5 h-5 text-[#FFD700] mt-1 mr-3" />
                  <p className="text-gray-300">High-performance requirements for professional audience</p>
                </li>
              </ul>
            </div>
            <div>
              ...
              <div className="grid gap-6">
                <FeatureCard
                  ...
                  description="Created a sophisticated design that reflects the premium nature of the service."
                />
                <FeatureCard
                  icon={Users}
                  title="Clear Messaging"
                  description="Developed compelling copy that effectively communicates value proposition."
                />
                <FeatureCard
                  icon={Zap}
                  title="Conversion Focus"
                  description="Implemented strategic CTAs and optimized user journey for conversions."
                />
              </div>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-gray-400 mb-4">
                    The sales page was built with premium positioning in mind:
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-center text-gray-300">
                      <CheckCircle2 className="w-5 h-5 text-[#A3D1FF] mr-3" />
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#1b1b1b]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-gray-400 mb-16 max-w-3xl">
            Outstanding performance metrics reflecting premium positioning and exceptional user experience
          </p>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <StatCard value="90" label="Qualified Lead Rate" icon={Award} />
            <StatCard value="85" label="Visitor Engagement" icon={TrendingUp} />
            <StatCard value="70" label="Form Conversion" icon={CheckCircle2} />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Let's create a high-converting sales page that drives real results for your business.
          </p>
          <button
