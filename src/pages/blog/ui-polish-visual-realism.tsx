...
import { ArrowLeft, Calendar, Clock, Share2, Linkedin, Facebook, Link, ArrowRight, Palette, Eye, Layers, Lightbulb, Sparkles, Sun } from 'lucide-react';
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <div className="bg-[#1b1b1b] p-6 rounded-xl border border-white/10 my-8">
              <h4 className="text-white font-semibold mb-2 flex items-center">
                <Sun className="w-5 h-5 text-[#A78BFA] mr-2" />
...
.card:hover {
  ...
  transform: translateY(-1px);
            ...
            <div className="bg-[#1b1b1b] p-6 rounded-xl border border-white/10 my-8">
              <h4 className="text-white font-semibold mb-2 flex items-center">
                <Sparkles className="w-5 h-5 text-[#A78BFA] mr-2" />
