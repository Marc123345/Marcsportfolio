...
import { ArrowLeft, Calendar, Clock, Share2, Linkedin, Twitter, Facebook, Link as LinkIcon, ArrowRight, Target, DollarSign, Users, TrendingUp, CheckCircle, Mail } from 'lucide-react';
    ...
    <>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#1b1b1b]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-display-medium text-white mb-4">Ready to Grow Your Paving Business?</h2>
